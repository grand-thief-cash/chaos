...
set "paths=app\infra\go\common app\infra\go\application app\poc\infra\go\application app\poc\infra\go\client app\projects\cronjob app\poc\projects\cronjob app/projects/mimir"
