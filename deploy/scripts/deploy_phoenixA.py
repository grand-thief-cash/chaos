...
GO_PROJECT_PATH = "../../app/projects/phoenixA"
REMOTE_DEPLOY_PATH = "/home/machine/docker_deploy/phoenixA"
REMOTE_HOST = "192.168.31.72"
REMOTE_USER = "machine"
REMOTE_PASS = "123456"

DOCKERFILE_PATH = "../docker/dockerfile/Dockerfile-phoenixA"
...
def create_temp_compose(version):
    ...
    """
    tmp_compose = os.path.join(Path(GO_PROJECT_PATH).resolve(), "dist", f"phoenixA-{version}.yaml")
    # 如果文件已存在且不强制重新生成，则跳过
