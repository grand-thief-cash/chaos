...
const (
	EchoService_Say_FullMethodName = "/echo.EchoService/Say"
)
...
func (c *echoServiceClient) Say(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoReply, error) {
...
func (UnimplementedEchoServiceServer) Say(context.Context, *EchoRequest) (*EchoReply, error) {
...
func _EchoService_Say_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServiceServer).Say(ctx, req.(*EchoRequest))
	}
